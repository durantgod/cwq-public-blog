...
export default hopeTheme({
  hostname: "https://github.com/durantgod",

  author: {
    name: "Durant",
    url: "https://www.wqknowledge.top/",
  },
  ...
  repo: "https://github.com/durantgod",
  ...
  encrypt: {
    config: {
      "/encryptPosts/设计模式/encrypt.html": ["1234"],
      "/encryptPosts/设计模式/strategy.html": ["1234"],
      "/encryptPosts/设计模式/encryptChain.html": ["1234"],
      "/encryptPosts/设计模式/factory.html": ["1234"],
      "/encryptPosts/解决方案/秒杀系统方案.html": ["1234"],
      "/encryptPosts/解决方案/限流方案.html": ["1234"]
    },
  },
